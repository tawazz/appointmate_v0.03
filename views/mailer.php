...
$cal = new iCal($subject, $convener, $start, $end, $uid);
...
switch ($_GET['attmeth']) {
  ...
  case ('attached'):
    ...
    $message
      ->setBody($message_text)
      //->addPart($cal->toString(), 'text/calendar; METHOD=REQUEST') 
      ->attach($ical_attach);
    break;
    default:
...
if (isset($_GET['send']) and $_GET['send'] == "true") {
  ...
  $transport = Swift_SmtpTransport::newInstance('54.206.60.48',25)
//     ->setUsername('tawazzne')
//     ->setPassword('2T%!oLTOJE7D');
;
